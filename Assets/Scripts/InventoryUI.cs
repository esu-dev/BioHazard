        ...
        _character.OnInterect.AddListener(InteractedObject =>
        {
            if (InteractedObject is DroppedItem)
            {
                ...
                this.gameObject.GetComponent<FadeUI>().Visualize(0.25f).onComplete = () =>
                {
                    ...
                    _getItemImage.transform.DOMove(_getItemImageMarker2.transform.position, 0.25f).SetDelay(0.1f).onComplete = () => _eventTriggerProxy.gameObject.SetActive(true);
                    ...
                    _getItemImage.GetComponent<TextMeshProUGUI>().DOFade(1, 0.25f);
                };
